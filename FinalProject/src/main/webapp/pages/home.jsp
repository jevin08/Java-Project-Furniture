				   	...
				   	<c:forEach items="${products}" var="product">
				        <div class="col">
						  <div class="card shadow-sm">
						  	<img class="bd-placeholder-img card-img-top" width="100%" height="225" src="${product.picture[0].photoName}" alt="">
						    <div class="card-body">
							  <b style="color:blue;">${product.name}</b><br>
       					      Price : ${product.price}
       					      &nbsp;
       					      Discount : ${product.discount}
							  <p class="card-text">${product.description.container} </p>
